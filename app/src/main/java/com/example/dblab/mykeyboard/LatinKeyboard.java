...
//    }
     ...
     */
    void setImeOptions(Context context, int options) { // Resources res, int options) {
        ...
        switch (options&(EditorInfo.IME_MASK_ACTION|EditorInfo.IME_FLAG_NO_ENTER_ACTION)) {
            ...
            case EditorInfo.IME_ACTION_SEARCH:
                mEnterKey.icon = ContextCompat.getDrawable(
                        context,
            ...
            case EditorInfo.IME_ACTION_SEND:
                ...
                break;
            default:
                mEnterKey.icon = ContextCompat.getDrawable( //).getDrawable(
                        context,
